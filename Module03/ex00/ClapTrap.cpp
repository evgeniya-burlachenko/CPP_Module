...
/*   Updated: 2022/02/10 19:25:42 by skelly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
//атакует и причиняет урон
this->set_Energy_points(this->Energy_points - 1);
...
{ 
//если еще не умер то получил урон и если умер то умер:(
...
void ClapTrap::set_Name(std::string amount) { this->Name = amount; }
