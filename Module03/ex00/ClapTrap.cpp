...
/*   Updated: 2022/02/03 14:08:15 by skelly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{ 
	// this -> set_Hit_points((this -> get_Hit_points() - amount) > 0);
	...
	// 		this -> set_Hit_points((this -> get_Hit_points()) == 0);
	// this -> set_Hit_points((this -> get_Hit_points() - amount) > 0 ? (this -> get_Hit_points() - amount) : 0);
	else
	{
		std::cout << "ClapTrap " << this->get_Name() << " died" << std::endl;
		this->Hit_points = 0;
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->set_Hit_points(amount + this->get_Hit_points());
